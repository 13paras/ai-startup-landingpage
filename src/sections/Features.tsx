...
const FeatureTab = (
  ...
  const handleTabHover = () => {
    ...
    lottieRef.current.seek(0); // to make it happen every time we hover on animation
  ...
  return (
    ...
    >
      ...
      <div className="inline-flex size-12 items-center justify-center rounded-lg border-white/15">
        <DotLottiePlayer ref={lottieRef} src={props.icon} className="size-5" />
      </div>
...
export const Features = () => {
  ...
  const backgroundPosition = useMotionTemplate`${backgroundPositionX}% auto`;
